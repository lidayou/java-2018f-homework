...
import cn.AldebaRain.world.gui.*;
...
public class Main extends Application {
	...
	private void initGUIWorld() {
        try {
            ...
            windowLoader.setLocation(Main.class.getClassLoader().getResource("gui/WorldWindow.fxml"));
            ...
            borderLoader.setLocation(getClass().getClassLoader().getResource("gui/WorldBorder.fxml"));
