...
public class Calabash {	
	...
	public static void main(String[] args) {
		...
		CalabashBrother[] brothers = {theOldest, theSecond, theThird, theForth, theFifth, theSixth, theYoungest};
	...
	public static void shuffle(CalabashBrother[] brothers) {
	...
	public static void halfSort(CalabashBrother[] brothers) {
		 int start;
	     int end;
	...
	public static void display(CalabashBrother[] brothers) {
		for (CalabashBrother k : brothers) {
