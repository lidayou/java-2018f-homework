...
public class Diamond extends Formation{
	public Diamond() {
		...
		formation[5]=new Square(broadxLines-4,(int)Math.ceil((double)broadyLines/2)-1-1,new LittleMonster(""));
		formation[6]=new Square(broadxLines-4,(int)Math.ceil((double)broadyLines/2)-1+1,new LittleMonster(""));
		formation[7]=new Square(broadxLines-5,(int)Math.ceil((double)broadyLines/2)-1,new LittleMonster(""));
	}
}
