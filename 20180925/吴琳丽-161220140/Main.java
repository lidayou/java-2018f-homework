...
public class Main {
    public static void main(String[] args) {
        ...
        for(int i=0;i<Bnum;i++){
            ...
            HuluChangShe.SetTites(BF.Field,Hulux,Huluy,HuluFamily.Hulu);//将葫芦娃设置为长蛇队形
            ...
            Cheer.GCheer(Yeye,BF.Field,Yeyex,Yeyey);
            System.out.println("请输入蛇精的横坐标: ");
            int Shex=in.nextInt();
            System.out.println("请输入蛇精的纵坐标:  ");
            int Shey=in.nextInt();
            Cheer.SCheer(she,BF.Field,Shex,Shey);
            System.out.println("显示此时的战场情况为:  ");
            BF.DisplayField();//显示战场
