...
public class FengShi implements Formation {
    ...
    public void Setcreatures(Coordinate[][] Field, int x, int y, Creature[] creatures) {
        ...
        Field[x-1][y+3].empty=false;
        Field[x-2][y+3].creature=creatures[8];
        Field[x-2][y+3].empty=false;
        Field[x-3][y+3].creature=creatures[9];
        Field[x-3][y+3].empty=false;
        Field[x-2][y+4].creature=creatures[10];
        Field[x-2][y+4].empty=false;
        Field[x-1][y+5].creature=creatures[11];
        Field[x-1][y+5].empty=false;
        Field[x][y+6].creature=creatures[12];
