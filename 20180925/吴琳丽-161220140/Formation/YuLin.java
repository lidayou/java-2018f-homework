...
public class YuLin implements Formation {
    ...
    public void SetTites(Coordinate[][] Field, int x, int y, Tite[] tites) {
        ...
        Field[x][y+2].tite=tites[1];
        Field[x][y+2].empty=false;
        Field[x][y+4].tite=tites[2];
        Field[x][y+4].empty=false;
        Field[x][y+6].tite=tites[3];
        ...
        Field[x-1][y+5].tite=tites[6];
        Field[x-1][y+5].empty=false;
        Field[x-2][y+4].tite=tites[7];
        Field[x-2][y+4].empty=false;
        Field[x-3][y+3].tite=tites[7];
