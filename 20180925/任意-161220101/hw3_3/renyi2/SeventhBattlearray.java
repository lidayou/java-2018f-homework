...
public class SeventhBattlearray implements Battlearray {
    ...
    public void createbattlearray(Field f, boolean ifhelp) {
        ...
        f.setposition(N/2-1,2*N/3,one=new Orchin(N/2-1,2*N/3));
        f.setposition(N/2+1,2*N/3,one=new Orchin(N/2+1,2*N/3));
        f.setposition(N/2-1,2*N/3-1,one=new Orchin(N/2-1,2*N/3-1));
        f.setposition(N/2+1,2*N/3-1,one=new Orchin(N/2+1,2*N/3-1));
        f.setposition(N/2,2*N/3-1,one=new Orchin(N/2,2*N/3-1));
        f.setposition(N/2-1,2*N/3-2,one=new Orchin(N/2-1,2*N/3-2));
        f.setposition(N/2+1,2*N/3-2,one=new Orchin(N/2+1,2*N/3-2));
        f.setposition(N/2,2*N/3-2,one=new Orchin(N/2,2*N/3-2));
        f.setposition(N/2-2,2*N/3-1,one=new Orchin(N/2-2,2*N/3-1));
        f.setposition(N/2-2,2*N/3,one=new Orchin(N/2-2,2*N/3));
        f.setposition(N/2-3,2*N/3,one=new Orchin(N/2-3,2*N/3));
        f.setposition(N/2-3,2*N/3+1,one=new Orchin(N/2-3,2*N/3+1));
        f.setposition(N/2-4,2*N/3+2,one=new Orchin(N/2-4,2*N/3+2));
        f.setposition(N/2+2,2*N/3-1,one=new Orchin(N/2+2,2*N/3-1));
        f.setposition(N/2+2,2*N/3,one=new Orchin(N/2+2,2*N/3));
        f.setposition(N/2+3,2*N/3,one=new Orchin(N/2+3,2*N/3));
        f.setposition(N/2+3,2*N/3+1,one=new Orchin(N/2+3,2*N/3+1));
